...
export default function ModalUpdateAnnouncement({ isOpen, onClose, onUpdate, announcementData }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="border-blue-primary-500 relative w-full max-w-md rounded-lg border-r-4 border-b-4 bg-white p-6 shadow-xl">
        ...
        {/* Modal Title */}
        <h2 className="mb-6 text-2xl font-semibold">Edit Pengumuman</h2>
