...
export default function CreatePermission() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log("API URL: http://localhost:8000/api/permission-letters");
          ...
          <form onSubmit={handleSubmit}>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full h-32 rounded-md border border-gray-300 bg-white p-3 text-gray-900 outline-none focus:ring-2 focus:ring-blue-300 resize-none"
                    required
                    ...
                    <div className="flex h-48 w-full flex-col items-center justify-center rounded-md border-2 border-dashed border-gray-300 bg-white p-4">
                      {supportingDocument ? (
                        <div className="text-center w-full">
                          <p className="text-sm text-gray-600 mb-2">Dokumen URL:</p>
                          <p className="text-xs text-gray-500 break-all mb-3">{supportingDocument}</p>
                          <button
                            type="button"
                        ...
                        <div className="text-center w-full space-y-3">
                          ...
                          <button
                            type="button"
                            className="rounded-md bg-[#112456] px-4 py-2 text-sm font-medium text-white hover:bg-[#0d1a3f] transition-colors"
                          >
                            Upload
                          </button>
                        </div>
            ...
            <div className="mt-6 flex justify-end">
              <button
                ...
                className="flex items-center gap-2 rounded-md bg-[#112456] px-6 py-3 font-semibold text-white hover:bg-[#0d1a3f] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
